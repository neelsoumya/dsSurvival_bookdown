...
Please install R and R Studio. We assume that the reader is familiar with R and DataSHIELD.
...
We outline some of the prerequisites that need to be installed below:
