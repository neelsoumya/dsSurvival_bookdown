...
The scope of our package implemenation is restricted to being study-level meta-analysis (SLMA) rather than full likelihood.
...
We will look at how age and gender affect survival time and then meta-analyze the hazard ratios.
...
Cox proportional hazards models. The functions are shown below:
