...
If the proportional hazards assumptions are violated (p-values less than 0.05), then you have to modify the model. Modifications can include introducing strata or time-dependent covariates. Please see the links below for more information on this.
